...
public class SalamanderModel<T extends SalamanderEntity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BlusBeastsMod.MODID, "salamander"), "main");
    ...
    public void setupAnim(SalamanderEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animate(entity.scratchLeftAnimation, SalamanderAnimation.scratchingLeft, ageInTicks, 1f);
        this.animate(entity.scratchRightAnimation, SalamanderAnimation.scratchingRight, ageInTicks, 1f);
        this.animateWalk(SalamanderAnimation.walking, limbSwing, limbSwingAmount, 8f, 7.5f);
    }
