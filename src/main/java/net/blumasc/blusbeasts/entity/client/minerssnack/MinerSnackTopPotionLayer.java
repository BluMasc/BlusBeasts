...
public class MinerSnackTopPotionLayer extends RenderLayer<MinersSnackEntity, MinerSnackModel<MinersSnackEntity>> {
    public MinerSnackTopPotionLayer(RenderLayerParent<MinersSnackEntity, MinerSnackModel<MinersSnackEntity>> renderer) {
        super(renderer);
    }
    ...
    private ResourceLocation getFinTextureLocation(MinersSnackEntity minersSnackEntity) {
        String location = "textures/entity/minersnack/texture_potion_top_"+(minersSnackEntity.getDurationTop()+1)+".png";
