...
public class GemCrabModel  <T extends GemCrabEntity> extends HierarchicalModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BlusBeastsMod.MODID, "gemcrab"), "main");
    private final ModelPart root;
    private final ModelPart pupil1;
    private final ModelPart pupil2;
    private final ModelPart crystal;

    public GemCrabModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(GemCrabEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animate(entity.snapAnimationState, GemCrabAnimation.pancerSnip, ageInTicks, 1f);
        this.animateWalk(GemCrabAnimation.walking, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.animate(entity.idleAnimationState, GemCrabAnimation.idle, ageInTicks, 1f);
    }
