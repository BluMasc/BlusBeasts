package net.blumasc.blusbeasts.entity.client.packwing;
    ...
    private static final Map<PackwingVariant, ResourceLocation> LOCATION_BY_VARIANT=
            Util.make(Maps.newEnumMap(PackwingVariant.class), map ->{
                map.put(PackwingVariant.BLUE,
                        ResourceLocation.fromNamespaceAndPath(BlusBeastsMod.MODID,"textures/entity/packwing/blue_packwing.png"));
                map.put(PackwingVariant.PINK,
                        ResourceLocation.fromNamespaceAndPath(BlusBeastsMod.MODID,"textures/entity/packwing/pink_packwing.png"));
                map.put(PackwingVariant.CYAN,
                        ResourceLocation.fromNamespaceAndPath(BlusBeastsMod.MODID,"textures/entity/packwing/cyan_packwing.png"));
                map.put(PackwingVariant.LIME,
                        ResourceLocation.fromNamespaceAndPath(BlusBeastsMod.MODID,"textures/entity/packwing/lime_packwing.png"));
                map.put(PackwingVariant.RED,
                        ResourceLocation.fromNamespaceAndPath(BlusBeastsMod.MODID,"textures/entity/packwing/red_packwing.png"));
            });
