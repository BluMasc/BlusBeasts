...
public class OctopusMushroomModel<T extends LivingEntity> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BlusBeastsMod.MODID, "octopusmushroommodel"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(26, 10).addBox(-1.0F, -1.0F, 0.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(-0.31F)), PartPose.offsetAndRotation(-1.5F, -2.0F, 1.0F, 0.0F, -0.48F, 0.0F));

        PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(10, 9).addBox(-3.0F, -1.0F, 0.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(-0.31F)), PartPose.offsetAndRotation(-1.5F, -3.0F, 3.0F, 0.0F, -0.3927F, 0.0F));

        PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(22, 8).addBox(-1.0F, -1.0F, 0.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(-0.31F)), PartPose.offsetAndRotation(-2.5F, -2.0F, -2.0F, 0.0F, 0.4363F, 0.0F));

        PartDefinition cube_r4 = body.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(6, 29).addBox(-2.0F, -1.0F, 0.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.31F)), PartPose.offsetAndRotation(-3.5F, -2.0F, -1.0F, 0.0F, 1.5272F, 0.0F));

        PartDefinition cube_r5 = body.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(10, 7).addBox(-3.0F, -1.0F, 0.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(-0.31F)), PartPose.offsetAndRotation(-5.5F, -3.0F, -1.0F, 0.0F, 1.5272F, 0.0F));

        PartDefinition cube_r6 = body.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(10, 5).addBox(-3.0F, -1.0F, 0.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(-0.31F)), PartPose.offsetAndRotation(-2.5F, -3.0F, -4.0F, 0.0F, 0.4363F, 0.0F));

        PartDefinition tentacle = body.addOrReplaceChild("tentacle", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -3.0F, -6.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(-0.3F)), PartPose.offset(-0.5F, -1.0F, 0.0F));

        PartDefinition cube_r7 = tentacle.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(26, 12).addBox(-0.5F, 0.0F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, -6.0F, 0.7418F, 0.0F, 0.0F));

        PartDefinition cube_r8 = tentacle.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(20, 0).addBox(-1.0F, -1.5F, 0.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(0.0F, -1.0F, -6.0F, 0.4363F, 0.0F, 0.0F));

        PartDefinition cube_r9 = tentacle.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(0, 20).addBox(-0.8F, -3.5F, -1.2F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, -1.0F, -1.0F, 1.1303F, 0.0795F, -0.1041F));

        PartDefinition cube_r10 = tentacle.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(18, 11).addBox(-0.8F, -2.5F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, -1.0F, -1.0F, 0.9558F, 0.0795F, -0.1041F));

        PartDefinition cube_r11 = tentacle.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(10, 11).addBox(-0.8F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, 0.0F, -1.0F, 0.6504F, 0.0795F, -0.1041F));

        PartDefinition tentacle2 = body.addOrReplaceChild("tentacle2", CubeListBuilder.create().texOffs(0, 5).addBox(-1.0F, -3.0F, -6.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-0.5F, -1.0F, 0.0F, 0.0F, 1.0908F, 0.0F));
        ...
        PartDefinition tentacle3 = body.addOrReplaceChild("tentacle3", CubeListBuilder.create().texOffs(0, 10).addBox(-1.0F, -3.0F, -6.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-0.5F, -1.0F, 0.0F, 0.0F, 2.0508F, 0.0F));
        ...
        PartDefinition tentacle4 = body.addOrReplaceChild("tentacle4", CubeListBuilder.create().texOffs(10, 0).addBox(-1.0F, -3.0F, -6.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-0.5F, -1.0F, 0.0F, 0.0F, -3.0543F, 0.0F));
