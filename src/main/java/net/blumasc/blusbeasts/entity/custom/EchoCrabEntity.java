...
public class EchoCrabEntity extends GemCrabEntity{
    ...
    public EchoCrabEntity(EntityType<? extends PathfinderMob> entityType, Level level) {
    ...
    private class ConsumeExperienceGoal extends Goal {
        ...
        @Override
        public boolean canUse() {
            if(!Config.REGENERATE_ECHO_CRABS.get())return false;
