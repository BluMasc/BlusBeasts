package net.blumasc.blusbeasts.item.client.curios.armcrystal;
...
public class ArmCrystalsRenderer implements ICurioRenderer {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(BlusBeastsMod.MODID, "textures/entity/curio/arm_crystals.png");
    private static final ResourceLocation TEXTURE_DIAMOND = ResourceLocation.fromNamespaceAndPath(BlusBeastsMod.MODID, "textures/entity/curio/arm_crystals_diamond.png");
